...
import profile from "../assets/photo_2023-09-29_12-46-59.jpg"
        ...
        <div name='About' className=' pt-8 h-full min-h-screen w-full flex items-center  bg-gradient-to-b to-black via-black from-gray-800 '>
            <div className='section justify-between'>
                ...
                <div className='flex flex-col justify-center w-full px-2 xs: sm:px-12 md:px-4 lg:px-14 text-white '>
                    <h3 className='text-2xl xs:text-3xl  sm:text-4xl md:text-4xl lg:text-5xl font-semibold '>Hi, I'm <span className='text-cyan-500 block xs:inline'>Mansurbek Rahmonaliyev</span></h3>
                    <div className='text-gray-400 py-4 space-y-2 md:space-y-2 md:pt-8 lg:pt-12 font-semibold text-justify'>
                        <p className='leading-tight'>
                        Frontend web developer based in Uzbekistan. I mainly work on Frontend using React and Tailwind CSS.
                        </p>
                        <p className='leading-tight'> I also love to make beautiful Web Applications with technologies like MERN Stack, NextJs.</p>
                        <p className='leading-tight'>
                        I graduated from the Tashkent University of Information Technologies named after Muhammad al-Khorazmi, majoring in information security. Currently, I am studying the frontend course at Najot Education IT Training Center
                        </p>
                    </div>
